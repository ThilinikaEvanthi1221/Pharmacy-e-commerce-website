...
function openNav(x) {
  ...
  if (x === 1) {
    document.getElementById("mySidenav").innerHTML = `
      ...
      <input id="myName"" type="text" placeholder="eg. Pabodha Perera" style="height: 45px; width: 440px; font-size: 16px; border-radius: 5px; text-align: center;"><br><br>
      <button style="height: 45px; width: 440px; border-radius: 5px;color: white;background-color: hsl(5, 100%, 73%); font-size: 16px; font-weight: bold;  border: 0ch;"  onClick="myCard()">Pay Now</button>
      </div>
      </div>
    ...
    document.getElementById(
      ...
      <br><br>
      <button  style="height: 45px; width: 440px; border-radius: 5px; background-color: hsl(5, 100%, 73%);color:white; font-size: 16px; font-weight: bold;  border: 0ch;"  onClick="myMobile()">Pay Now</button>
      </div>
      </div>
      `;
  } else if (x === 3) {
    ...
    document.getElementById(
      ...
      <div style=" height: 380px;  text-align: center;">
      <img  alt="icon" src="https://koko-merchant.oss-ap-southeast-1.aliyuncs.com/bnpl-site-cms-dev/kokoIframeImages/MAINLogo-HD_H_21.01.05.png" style="-webkit-tap-highlight-color: transparent; border: 0px; box-sizing: border-box; font: inherit; height: 40px; margin: 0px; outline: none; padding: 0px; vertical-align: baseline; width: 40px;" />
      <h3 style="font-size: 16px;  text-align: center;" class="paymentTxt">Enter Your KOKO Pay ID</h3> 
      <hr/>
      <div  style="margin: 10px; padding: 10px;" > 
      <br>
      <label style="">ID</label><br><br>
      <input class="myMobile" type="tel" maxlength="10" style="height: 45px; width: 440px; font-size: 16px; border-radius: 5px; text-align: center;" placeholder="1234567890" required autofocus><br>
      <br><br>
      <button   style="height: 45px; width: 440px; border-radius: 5px; background-color: hsl(5, 100%, 73%); color:white ; font-size: 16px; font-weight: bold;  border: 0ch;"  onClick="myMobile()">Pay Now</button>
      </div>
...
window.addEventListener("load", function () {
  document.getElementById("myTotal1").innerText = "Rs." + CartTotal;
  var myAdd = parseFloat(CartTotal);
  myAdd += 133;
  document.getElementById("myTotal2").innerText = `Rs.${myAdd.toFixed(2)}`;
});
function myMobile() {
